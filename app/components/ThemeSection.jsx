...
export default function ThemeSection() {
  return (
    <section className="relative py-28 bg-gradient-to-b from-emerald-50 via-white to-green-50">
      ...
      <div className="relative max-w-7xl mx-auto px-4 md:px-8">
        ...
        >
          ...
          <p className="text-xl md:text-2xl font-semibold text-emerald-600 mb-2">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-6">
            <h3 className="text-lg font-bold text-blue-600 mb-4">🔬 PHYSICS</h3>
          ...
          {/* Chemistry */}
          <div className="bg-white rounded-3xl shadow-xl p-6">
            <h3 className="text-lg font-bold text-pink-600 mb-4">🧪 CHEMISTRY</h3>
            <ul className="space-y-2 text-gray-700 text-sm">
          ...
          {/* Biology */}
          <div className="bg-white rounded-3xl shadow-xl p-6">
            <h3 className="text-lg font-bold text-green-600 mb-4">🧬 BIOLOGY</h3>
            <ul className="space-y-2 text-gray-700 text-sm">
          ...
          {/* Mathematics */}
          <div className="bg-white rounded-3xl shadow-xl p-6">
            <h3 className="text-lg font-bold text-purple-600 mb-4">📐 MATHEMATICS</h3>
            <ul className="space-y-2 text-gray-700 text-sm">
