...
//   return (
//     <section className="relative py-28 bg-gradient-to-b from-indigo-50 via-white to-sky-50">
...
//             The exhibition is designed to inspire curiosity, creativity, and
...
//               className="bg-white/90 backdrop-blur rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition group"
//             >
//               {/* Image */}
...
export default function Objectives() {
  return (
    <section className="relative py-28 bg-gradient-to-b from-indigo-50 via-white to-sky-50 overflow-hidden">
